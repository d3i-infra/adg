...
`pnpm add -g @d3i-infra/adg` (macOS, Linux, Windows), `yay -S adg-bin` (Arch; not yet available), or
`go install github.com/d3i-infra/adg/v4@latest`. The full table is in the
